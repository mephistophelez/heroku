...
export declare class InteractionManager {
    ...
    onDocumentMouseMove: (mouseEvent: MouseEvent | PointerEvent) => void;
    onTouchMove: (touchEvent: TouchEvent) => void;
    onMouseClick: (mouseEvent: MouseEvent) => void;
    onMouseDown: (mouseEvent: MouseEvent | PointerEvent) => void;
    onTouchStart: (touchEvent: TouchEvent) => void;
    onMouseUp: (mouseEvent: MouseEvent | PointerEvent) => void;
